(function() {
 ...
 $('.filters ul li').click(function(){
	...
	document.getElementById('downloadCv').addEventListener('click', function(event) {
		...
		// Konten file yang ingin diunduh
		const content = 'Ini adalah konten CV Anda'; // Ganti dengan konten file atau URL
		const filename = 'CV-Dinamis.pdf'; // Nama file yang akan diunduh
		...
		// Membebaskan URL Object setelah selesai
